package com.azzdorfrobotics.android.testio.features.shared.views;
...
public class CircularProgressView extends View {
    ...
    private void initAttributes(AttributeSet attrs, int defStyle) {
        final TypedArray a =
            getContext().obtainStyledAttributes(attrs, R.styleable.CircularProgressView, defStyle,
                0);
        ...
        //    TypedArray t =
        //        getContext().obtainStyledAttributes(new int[] { android.R.attr.colorAccent });
