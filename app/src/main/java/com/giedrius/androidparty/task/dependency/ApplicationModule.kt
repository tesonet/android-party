...
import com.giedrius.androidparty.task.api.login.LoginClientImplementation
...
class ApplicationModule {
    ...
    @Provides
    fun provideRepository(loginClient: LoginClient, sharedPreferences: SharedPreferences): Repository =
        RepositoryImplementation.getInstance(loginClient, sharedPreferences)

    @Provides
    fun provideLoginClient(): LoginClient = LoginClientImplementation()
