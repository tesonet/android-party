...
public final class LoginFragmentModule_ProvideLoginViewModelFactory$app_debugFactory implements Factory<ViewModel> {
  private final Provider<LoginModel> modelProvider;

  private final Provider<InternetStateProvider> internetStateProvider;

  public LoginFragmentModule_ProvideLoginViewModelFactory$app_debugFactory(
  ...
  public static LoginFragmentModule_ProvideLoginViewModelFactory$app_debugFactory create(
      Provider<LoginModel> modelProvider, Provider<InternetStateProvider> internetStateProvider) {
    return new LoginFragmentModule_ProvideLoginViewModelFactory$app_debugFactory(modelProvider, internetStateProvider);
  }
  ...
  public static ViewModel provideLoginViewModelFactory$app_debug(LoginModel model,
    ...
    return Preconditions.checkNotNull(LoginFragmentModule.provideLoginViewModelFactory$app_debug(model, internetStateProvider), "Cannot return null from a non-@Nullable @Provides method");
  }
}
