...
import com.baruckis.remote.API_TESONET_SERVICE_BASE_URL
...
object TesonetApiServiceFactory {
    ...
    fun createTesonetApiService(
        ...
        return createRetrofit(
            ...
            createOkHttpClient(isDebug, localDataSource),
            Gson()
    ...
    private fun createOkHttpClient(
        ...
        return OkHttpClient.Builder()
             ...
             */
            .addInterceptor(AuthenticationInterceptor(localDataSource))
            /**
